...
<body>
    ...
    ?>
    <div id="body">
        <h4>Impressum</h4><p><b>Informationen und Offenlegung gemäß &sect;5 (1) ECG, &sect; 25 MedienG, &sect; 63 GewO und &sect; 14 UGB</b></p> <p><b>Webseitenbetreiber:</b> Manuel Mayr</p>
        <p><b>Anschrift:</b> Plöckensteinstraße, 19, 4164 Schwarzenberg am Böhmerwald</p>
        <p><b>UID-Nr:</b>  <br> <b>Gewerbeaufsichtbehörde:</b>  <br> <b>Mitgliedschaften:</b></p>
        <p><b>Kontaktdaten:</b> <br> Telefon:  <br> Email: mayr.manuel29@gmail.com <br> Fax: </p>
        ...
        <p><span>Rechtstext von </span>Quelle: fairesRecht.at in Kooperation mit <b><a href="https://haustechnik-profi.at/wärmepumpe-kaufen" style="color: white">Wärmepumpe Österreich</a></b></p>
    </div>
    <?php
        include("footer.php");
    ?>
